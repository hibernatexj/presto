...
There are a number of ways to try and install Presto. Read this documentation page 
...
==========================
Install Presto on a cluster of nodes manually or automated using Apache Ambari. 
And either with or without YARN integration.
