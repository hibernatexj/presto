...
You can use Apache Ambari to install Presto. To install Presto using Ambari, you must have 
the `Presto Ambari Integration package <https:www.teradata.com/presto>`_. 
