        ...
        extends AbstractTestFunctions
{
    ...
    public void testIsNaN()
    {
        ...
        assertFunction("is_nan(finfinity() / finfinity())", BOOLEAN, true);
        assertFunction("is_nan(nan())", BOOLEAN, true);
            ...
            throws Exception
    {
        ...
        functionAssertions.tryEvaluate("width_bucket(finfinity(), 0, 4, " + Long.MAX_VALUE + ")", DOUBLE);
    }
            ...
            throws Exception
    {
        ...
        functionAssertions.tryEvaluate("width_bucket(finfinity(), 4, 0, " + Long.MAX_VALUE + ")", DOUBLE);
    }
