    ...
    implements HashAggregationBuilder
{
    ...
    private final List<Iterator<Page>> spills;
    ...
    {
        MergeSort mergeSort = new MergeSort(groupByTypes, hashAggregationBuilder.buildIntermediateTypes());
        Iterator<Page> mergedSpilledPages = mergeSort.merge(spills);
        ...
        return new Iterator<Page>() {
            ...
            {
                return mergedSpilledPages.hasNext() || resultPages.hasNext();
            }
            ...
            public Page next()
            {
                if (!resultPages.hasNext()) {
                    ...
                    while (mergedSpilledPages.hasNext() && !shouldProduceOutput(memorySize)) {
                        hashAggregationBuilder.processPage(mergedSpilledPages.next());
    ...
    {
        return hashAggregationBuilder.isBusy();
    }
